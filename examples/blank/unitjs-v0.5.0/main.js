...
if(!module.disable_alert)alert(msg);throw new Error(msg);};module.run=function(test_module){var results,section;module.validate(test_module.statements);section=module.prepare(test_module.statements,test_module.tests);results=module.process(section);results=module.total(results);return results;}
